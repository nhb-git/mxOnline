    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organizations.Teacher', verbose_name='课程老师')),
            ],
            options={
                'verbose_name': '课程信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(max_length=200, upload_to='course/resources/%Y/%m', verbose_name='课程资源文件下载地址')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.Course', verbose_name='课程')),
            ],
            options={
                'verbose_name': '课程资源信息',
